	...
	class Flat_VCExtend {
		...
		public static function themesflat_portfolio( $atts, $content = null ) {
	        ...
	        if ( has_post_thumbnail() ):	
	            ...
	            echo '</div>';	            
	            if ( $hide_title != 'yes' ) {
	            	echo '<div class="title-post"><a title="' . get_the_title() . '" href="' . get_the_permalink() . '">' . get_the_title() . '</a><br><span class="portfolio-date"><i class="far fa-clock"></i>&nbsp;' . get_the_date() . '</span></div>';
	            }
